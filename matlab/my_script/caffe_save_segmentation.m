...
%pause;
% set data path
dataChoice = 'Trainingset';
dataDir = ['/BS/joint-multicut/work/FBMS59/' dataChoice '/'];
Type = '*.ppm';
inMat  = ['/BS/joint-multicut-2/work/FBMS-fasterRCNN/' dataChoice '02/'];
outMat = ['/BS/joint-multicut-2/work/FBMS-fasterRCNN/deeplab/' dataChoice '02/'];
folder = dir(dataDir);
folder(1:2)=[];
