...
if is_server
  if strcmp(dataset, 'voc12')
    VOC_root_folder = '/home/zhongjie/CodesDown/jointmulticut/joint-multicut/deeplab/deeplab/code/voc12';
...
output_mat_folder = fullfile('/home/zhongjie/CodesDown/jointmulticut/joint-multicut/deeplab/deeplab/exper', dataset, feature_name, model_name, testset, feature_type);

save_root_folder = fullfile('/home/zhongjie/CodesDown/jointmulticut/joint-multicut/deeplab/deeplab/exper', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder);
